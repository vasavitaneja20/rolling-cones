    ...
    <main className="menu-page container">
      <header className="menu-page__header">
        ...
        <p className="menu-page__subtitle">
          Explore sweet cravings and savory delights, made fresh for every order.
        </p>
      </header>
      ...
      <div className="menu-page__sections">
        {showSweet && (
          <section className="menu-page__section">
            ...
            <div className="menu-page__grid">{renderCards(categorizedItems.sweet)}</div>
          </section>
        )}
        ...
        {showSavory && (
          <section className="menu-page__section">
            ...
            <div className="menu-page__grid">{renderCards(categorizedItems.savory)}</div>
          </section>
        )}
      </div>
    </main>
